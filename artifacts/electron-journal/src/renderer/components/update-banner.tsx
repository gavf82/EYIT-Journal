...
export function UpdateBanner() {
  ...
  if (status.phase === "downloaded") {
    return (
      <div className="fixed top-0 left-0 right-0 z-50 flex items-center justify-between gap-3 bg-emerald-700 px-4 py-2 text-sm text-white shadow-md print:hidden">
        <span>
        ...
        <button
          ...
          className="shrink-0 rounded bg-white/20 px-3 py-0.5 font-medium transition-colors hover:bg-white/30"
        >
          Restart now
        </button>
      </div>
