...
- **Contact form**: `/contact` posts to Web3Forms. Requires `VITE_WEB3FORMS_KEY` set as a Replit secret (sign up free at web3forms.com). If the variable is absent the page shows a graceful "Contact unavailable" notice.
